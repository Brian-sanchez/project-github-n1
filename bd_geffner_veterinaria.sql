...
INSERT INTO Historial (Fecha, Perro, Descripcion, Monto)
        VALUES ('2021-10-25', 1, 'Examen', 8900), ('2022-05-08', 2, 'Corte de Pelo', 2200), ('2022-08-05', 3, 'Corte de Pelo', 2200);
SELECT
    *
FROM
    Dueno;
...
INSERT INTO Dueno (DNI, Nombre, Apellido, Telefono, Direccion)
        VALUES (27727222, 'John', 'Perez', 3547237215, 'Salta 74'), INSERT INTO Perro (Nombre, Fecha_nac, Sexo, DNI_Dueno)
            VALUES ('Python', '2013-10-12', 'Macho', 25937321), INSERT INTO Historial (Fecha, Perro, Descripcion, Monto)
                VALUES ('2022-02-25', 4, 'Examen', 8900),
                -- Actividad 4 - Actualice la fecha de nacimiento de algún animal (perro) que usted considere.
                UPDATE
                    Perro
                SET
                    Fecha_nac = 2012 / 11 / 12
                WHERE
                    dni = 28957346
